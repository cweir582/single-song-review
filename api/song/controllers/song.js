...
module.exports = {
      ...
      if (!artist) {
        ...
        await strapi.plugins["email"].services.email.send({
          ...
          text:
            ...
            "/submit-song/confirmation?token=" +
            token,
        });
  ...
  async random() {
    ...
    const songs = await strapi.query("song").find({ picked: false });
    ...
    return sanitizeEntity(song || getRandomsong(songs), {
      model: strapi.models.song,
    });
  },
};
